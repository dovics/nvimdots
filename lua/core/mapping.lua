...
local def_map = {
	...
	["n|J"] = map_cmd("5j"):with_noremap():with_desc("editn: Move down 5 lines"),
	["n|K"] = map_cmd("5k"):with_noremap():with_desc("editn: Move up 5 lines"),
	["n|H"] = map_cmd("5h"):with_noremap():with_desc("editn: Move left 5 lines"),
	["n|L"] = map_cmd("5l"):with_noremap():with_desc("editn: Move right 5 lines"),
